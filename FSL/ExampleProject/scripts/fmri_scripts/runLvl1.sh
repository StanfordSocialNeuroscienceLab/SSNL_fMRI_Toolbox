...
for r in 1 2 3 4
    ...
    sed -i -e 's/ChangeMyRun/'$r'/' ../design/$design/subj${subjID}_task_run${r}.fsf      sed -i -e 's/ChangeMySubj/'$subjID'/' ../design/$design/subj${subjID}_task_run${r}.fsf
    ...
    sed -i -e 's/ChangeMyDesign/'$design'/' ../design//$design/subj${subjID}_task_run${r}.fsf  #Swap "ChangeMyRun" with run number
